...
def render():
    ...
    with tab_static:
        ...
        with st.spinner("⏳ Computing impulse response, please wait…"):
            _, plot_data = impulse_response_analysis(
                model,
    ...
    with tab_anim:
        ...
        with st.spinner("⏳ Computing impulse response in animation format, please wait…"):
